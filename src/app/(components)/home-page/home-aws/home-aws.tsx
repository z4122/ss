...
export const HomeAws: React.FC = () => {
  return (
    <div className={styles.homeAws}>
      <div className={classNames(commonStyles.sectionContent, commonStyles.container, styles.centeredTextBlock)}>
        <a href="/aws/">
          <Image
            alt={'aws img'}
            width={90}
        ...
        <div className={classNames(commonStyles.sectionText, styles.sectionTextReversed)}>
          The industry-leading services of AWS help us to deliver our products to our wide range of clients.
        </div>
