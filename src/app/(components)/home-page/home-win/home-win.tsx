  ...
  return (
    <div className={classNames(commonStyles.sectionSplit, styles.homeWin)}>
      <div className={commonStyles.sectionSplitContent}>
        <h3 className={classNames(commonStyles.sectionHeader, styles.sectionHeaderReversed)}>For Teams</h3>
        <h2 className={classNames(commonStyles.sectionTitle, styles.sectionTitleReversed)}>Win More Games</h2>
        <p className={classNames(commonStyles.sectionText, styles.sectionTextReversed)}>
          Successful teams rely on our
          machine intelligence to find and share
          video, discover
          key insights, and be more informed in smarter, better and faster ways.
        </p>
