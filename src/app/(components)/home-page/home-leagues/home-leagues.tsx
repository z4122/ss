  ...
  return (
    <div className={classNames(commonStyles.sectionSplit, styles.homeLeagues)}>
      ...
      <div className={commonStyles.sectionSplitContent}>
        ...
        <h3 className={classNames(commonStyles.sectionTitle)}>
          Engage Viewers
        </h3>

        <p className={classNames(commonStyles.sectionText)}>
          Create personalized, interactive, augmented content and experiences
          powered by machine understanding of sports.
        </p>
