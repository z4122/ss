...
export const BannerHeader: React.FC<any> = ({}) => {
      ...
      <div className={styles.bannerHeader}>
        ...
        <div className={styles.navWrapper}>
          <nav className={styles.nav}>
            <ul>
              <li>
                <a className={classNames(styles.navLink, styles.hasSubNav)} href="/"
                   onMouseEnter={() => {
                ...
                {showCareersSubMenu && (
                  <div className={styles.subMenu}
                    ...
                    <div className={styles.subElement}>
                      <a className={styles.subLink} href="/careers/opportunities/"> Opportunities </a>
                    </div>
                    <div className={styles.subElement}>
                      <a className={styles.subLink} href="/careers/culture/"> Culture </a>
                    </div>
                  </div>
                )
                }
              ...
              <li>
                ...
                {showWorkSubMenu && (
                  <div className={styles.subMenu}
                    ...
                    <div className={styles.subElement}>
                      <a className={styles.subLink} href="/ourwork/teams-leagues/"> Teams & Leagues </a>
                    </div>
                    <div className={styles.subElement}>
                      <a className={styles.subLink} href="/ourwork/leagues-media/"> Leagues & Media </a>
                    </div>
                  </div>
                )
                }
              ...
              <li><a className={styles.navLink} href="/press">Press</a></li>
              <li><a className={styles.navLink} href="/videos">Videos</a></li>
              <li><a className={styles.navLink} href="/login">Login in</a></li>
            </ul>
          </nav>
        </div>
      </div>
